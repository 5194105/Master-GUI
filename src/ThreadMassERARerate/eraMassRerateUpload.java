...
public class eraMassRerateUpload extends Thread{
	...
	public eraMassRerateUpload(ArrayList<data> dataArray,config c) {
...
public void run () {
		...
		for(data d: dataArray) {
		    ...
		    if (vc.validateMassRerate(testInputNbr,tinCount,trkngnbr)==true) {
		    	continue;
		    }
		}
}
