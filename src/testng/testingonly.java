	...
	//	public void setupExcel(String filepathExcel) {
	  ...
	  //  public void testMethod1() {
		...
		if (!service2.equals("null")) {
			...
			doWork(driver1,wait1,CEDropDown1,alert1,r1,cc11,cc12,comboBoxesHandling1,isChecked1,count1,testInputNbr, tinCount, acct1, acct2, trkng1, trkng2, inv1, inv2, service1, service2, rerateType, acctType, name,combo1,ground1,express1,testCounter);
