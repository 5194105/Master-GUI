...
public class rebillAutomationGui {
	...
	private JFrame frame;
     ...
     private JLabel lblNewLabel_excel;
     private JLabel lblNewLabel_db;
	/**
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					rebillAutomationGui window = new rebillAutomationGui();
	...
	private void initialize() {
		...
		lblNewLabel_excel = new JLabel("New label");
		lblNewLabel_excel.setBounds(512, 335, 78, 56);
		frame.getContentPane().add(lblNewLabel_excel);
		
		lblNewLabel_db = new JLabel("New label");
		lblNewLabel_db.setBounds(619, 332, 78, 56);
		frame.getContentPane().add(lblNewLabel_db);
		...
		label_1.setBounds(413, 489, 284, 41);
		...
		radioButton_2.setFont(new Font("Segoe UI", Font.BOLD, 22));
		radioButton_2.setBounds(641, 405, 40, 29);
		...
		addIcon(lblNewLabel_excel,excelPic);
		addIcon(lblNewLabel_db,dbPic);
		addIcon(label_1,execute);
