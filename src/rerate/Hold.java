...
public class Hold {
	 ...
	 * 
	 */
	public Hold (String file,String level) throws IOException, InterruptedException{
		this.file=file;
	...
	public void  Hold1() throws IOException, InterruptedException {
		...
		driver.findElement(By.id("username")).sendKeys("947323");
		driver.findElement(By.id("password")).sendKeys("947323");
