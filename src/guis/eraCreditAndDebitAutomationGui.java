...
public class eraCreditAndDebitAutomationGui {
	 ...
	 */
	public eraCreditAndDebitAutomationGui(gui g,config c) {
		this.g=g;
		this.c=c;
	...
	private void initialize() {
		...
		lblRebillAutomation = new JLabel("<HTML><U>Credit and Debit<HTML><U>");
